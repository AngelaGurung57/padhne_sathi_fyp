...
class RequestBooks extends StatefulWidget {
  @override
  _RequestBooksState createState() => _RequestBooksState();
}
...
class _RequestBooksState extends State<RequestBooks> {
  item selectedUser;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Padhne Sathi,  Request Book'),
