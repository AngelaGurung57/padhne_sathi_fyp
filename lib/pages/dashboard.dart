...
class _DashBoardState extends State<DashBoard> {
      ...
      listItems.add(Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.all(
                  Radius.circular(20.0)), color: Colors.white, boxShadow:
          [
  ...
  Widget build(BuildContext context) {
    ...
    var color1 = Color.fromARGB(255, 124, 57, 167);
    return Scaffold(
      drawer: NavDrawer(),
      appBar: AppBar(
        title: Text('Padhne Sathi'),
          ...
          child: Row(
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(color:Color(0xFFF57C00), borderRadius: BorderRadius.all(Radius.circular(20.0))),
                child: Padding(
